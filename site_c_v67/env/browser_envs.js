...
// 目标站点信息 (base64 匿名化存储, 运行时解码)
var TARGET_URL = Buffer.from('aHR0cHM6Ly9zdWdoLnN6dS5lZHUuY24vSHRtbC9OZXdzL01haW4vMTAyLmh0bWw=', 'base64').toString('utf8');
var _target_loc = new URL(TARGET_URL);
...
Location.prototype = {
    "ancestorOrigins": {},
    "href": TARGET_URL,
    "origin": _target_loc.origin,
    "protocol": "https:",
    "host": _target_loc.host,
    "hostname": _target_loc.hostname,
    "port": "",
    "pathname": _target_loc.pathname,
    "search": "",
    "hash": ""
}
